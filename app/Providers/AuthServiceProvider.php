...
class AuthServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        // pll
        Gate::define('pll', function($user){
            return $user->email=='quangkhjeu1@gmail.com';
        });
        // reup
        Gate::define('reup', function($user){
            return $user->reup==1;
        });
        Gate::define('kenhreup', function($user,$sl){
            return $user->kenhreup>$sl;
        });
    }
}
